...
use GraphAware\Neo4j\Client\ClientBuilder;
      ...
      //$client = ClientBuilder::create()->addConnection('default', 'http', '128.36.40.31', 7474, true, 'neo4j', 'linkedimm{300george}')->setAutoFormatResponse(true)->build();
//echo "test";
...
//echo shell_exec('/usr/lib/R/bin/Rscript dashboard.R 2>&1');
...
<div role="tabpanel">
  ...
  <!-- Tab panes -->
  <div class="tab-content" style="height:400px;padding:10px;"> 
    <div role="tabpanel" class="tab-pane active" id="graph" style="height:100px;padding:10px;">
    	<div class="tab-pane active" id="graph" style="height:100px;padding:10px;">&nbsp;
        <tabe align=center><tr align="center"><td align="center"> <img src=images/main.png alt=”R Graph” width="1000" height="900" /></td></tr>
        <tabe align=center><tr align="center"><td align="center"> <img src=images/main2.png alt=”R Graph” width="500" height="500" /></td></tr>
        <tabe align=center><tr align="center"><td align="center"> <img src=images/main3.png alt=”R Graph” width="500" height="500" /></td></tr>
