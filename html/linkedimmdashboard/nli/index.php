...
$client = ClientBuilder::create()
  ...
  ?>
    <form name="form1" method="GET" action="index.php">
      ...
      <h4>Click on Mic to Speak  <img src="//i.imgur.com/cHidSVu.gif" width="46" height="41" onclick="startDictation()" /> or Type a Query</h4>  <h6>Try: Plot Male subjects which are over 40 years old </h6>                    
...
echo $query = "match (s:Study)-[:Has_subject]->(p:Subject) where  s.accession=s.accession and p.gender =~ '(?i)".$gender."' and p.race=p.race and  p.age".$agecomparson. $age." return  s.accession,p.accession,p.age,p.gender,p.race";
...
// Close the file
 ...
 shell_exec("Rscript nli_dashboard.R");
...
<div role="tabpanel">
  ...
  <ul class="nav nav-tabs" role="tablist">
    ...
    <li role="presentation"><a href="#table" aria-controls="table" role="tab" data-toggle="tab"> <strong>Execusion Process</strong></a></li>
  </ul>
  ...
  <div class="tab-content" style="height:800px;"> 
    <div role="tabpanel" class="tab-pane active" id="graph" style="height:800px;">
        ...
        <tabe align=center><tr align="center"><td align="center"> <img src=nli_plot.png alt=”R Graph” width="841" height="675" /></td></tr>
</table>
        </div>
    </div>
    <div role="tabpanel" class="tab-pane" id="table">
    	<table class="table"><tr><td><strong>Natural Language Query Retrival</strong></td></tr>
       <tr><td> <?php echo  $query_value;?></td></tr>
      <tr><td> <strong>Calling the DialogFlow API</strong></td></tr>
        <tr><td>  <?php print_r($abc); ?>  </td></tr> 
       
       <tr><td><strong>Dynamic Formulating the Query</strong></td></tr>
       <tr><td> <?php echo $query;?></td></tr>
       <td><tr> </td></tr>
      <tr><td> <strong>Plotting</strong><img src=nli_plot.png alt=”R Graph” width="300" height="250"/></td></tr></table>
